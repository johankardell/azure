...
vnet_hub = {
  ...
  subnet_azurefirewall_name    = "AzureFirewallSubnet"
  subnet_azurefirewall_iprange = "10.0.0.0/24"

  subnet_gateway_name    = "GatewaySubnet"
  subnet_gateway_iprange = "10.0.1.0/24"

  subnet_jumpnet_name    = "subnet-jumpnet"
  subnet_jumpnet_iprange = "10.0.2.0/24"

  subnet_servernet_name    = "subnet-servernet"
  subnet_servernet_iprange = "10.0.3.0/24"
}
...
azurefirewall = {
  publicip_name = "pip-azurefirewall"
  name          = "fw-hub"
}
